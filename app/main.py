...
@st.cache_data
def load_data():
    df_benin = pd.read_csv("data/cleaned-data/benin-malanville_clean.csv")
    df_togo = pd.read_csv("data/cleaned-data/togo-dapaong_qc_clean.csv")
    df_sierra = pd.read_csv("data/cleaned-data/sierraleone-bumbuna_clean.csv")
